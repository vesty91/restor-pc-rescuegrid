...
if /i "%ISO%"=="O" (
    powershell -ExecutionPolicy Bypass -File "agent\windows\winpe\Build-RescueGridWinPE.ps1" -Force -BuildIso
) else (
    powershell -ExecutionPolicy Bypass -File "agent\windows\winpe\Build-RescueGridWinPE.ps1" -Force
)
pause

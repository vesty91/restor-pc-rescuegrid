...
echo ATTENTION : nécessite une invite administrateur (elevation UAC).
...
powershell -ExecutionPolicy Bypass -File "%~dp0agent\windows\Register-RescueGridScheduledTask.ps1" %ARGS%
echo.
echo Appuyez sur une touche pour revenir au menu...
pause >nul
goto MENU
...
powershell -ExecutionPolicy Bypass -File "%~dp0agent\windows\Register-RescueGridScheduledTask.ps1" -Unregister -ClientName "%CLIENT%"
echo.
echo Appuyez sur une touche pour revenir au menu...
pause >nul
goto MENU
